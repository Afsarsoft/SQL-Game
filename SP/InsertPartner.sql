CREATE OR ALTER PROCEDURE game.InsertPartner
    @CustomerID INT,
    @CountryID  TINYINT,
    @Email      NVARCHAR(50),
...
AS
/***************************************************************************************************
File: InsertPartner.sql
----------------------------------------------------------------------------------------------------
Procedure:      game.InsertPartner
Create Date:    2021-03-01 (yyyy-mm-dd)
Author:         Surush Cyrus
Description:    Insert a Customer
Call by:        game.AddOrder, Add hoc

Steps:          1- Check the @CountryID for RI issue in game.Country table
                2- Error out if @Email already is in table game.Customer
                3- Error out if @CustomerID <= 10000000
                4- Insert to table game.Customer
...
Usage:          game.InsertPartner @CustomerID = 100001052,
                                      @CountryID = 91,
...
BEGIN
    SET @ErrorText = 'CountryID = ' + CONVERT(VARCHAR(10), @CountryID) + ' not found in table Country! This is not acceptable. Rasing Error!';
